...
class TestScoreRun(unittest.TestCase):
    def test_perfect_service_scores_100(self):
        vehicles = [Vehicle("north", t, departed=t) for t in range(100)]
    ...
    def test_nobody_served_scores_zero_or_near(self):
        vehicles = [Vehicle("north", 0) for _ in range(50)]
    ...
    def test_starvation_threshold_and_cap(self):
        served_fast = [Vehicle("north", t, departed=t) for t in range(200)]
        starved = [
    ...
    def test_score_never_negative(self):
        vehicles = [Vehicle("north", 0) for _ in range(500)]
    ...
    def test_latency_tradeoff_monotonic(self):
        fast = [Vehicle("north", t, departed=t + 5) for t in range(100)]
        slow = [Vehicle("north", t, departed=t + 90) for t in range(100)]
        self.assertGreater(
...
class TestAggregation(unittest.TestCase):
    ...
    def test_total_score_weighted_mean(self):
        ...
        vehicles = [Vehicle("north", t, departed=t) for t in range(10)]
